...
public class GetOrderDashboardUI implements IUIScript {
...
//			Object jsonPathFormObj = gridViewAdapterScriptItemClick.getSelectField("layout_form");
...
//			uIBuilderItemClick.openFormFlowchartFragment(jsonPathForm, jsonPathFormflow_chart, str_activity);
//
//			// openFormFlowchart
//
...
//				"btnSeach");
//
//		Object post_collection_seach = uIBuilder.getScriptShadowParam("post_collection_seach");
//		ViewOnClickListener boiling_point_klispost_collection_seach = new ViewOnClickListener() {
//
...
//
//				MapObject objMapSech = uIBuilder.createListFieldNameValueShadow(MapObject.class, "mapObjectSeach");
//				uIBuilder.postData(objMapSech, post_collection_seach);
//
//			}
//		};
//
//		uIBuilder.<ViewOnClickListener>createShadowOnClickListener(boiling_point_klispost_collection_seach, "OnClickListenerSeach");
//		btnSeach.setOnClickListener(boiling_point_klispost_collection_seach);
	...
	private UIBuilder addClickButton(UIBuilder uIBuilder, String btnName ) {
		Button btnSend = uIBuilder.<Button>createShadow(Button.class,
				btnName);
