...
public class ReportUser extends ServiceBase {
...
//owner_id
				...
				FirebaseDatabase.getInstance().getReference()
						.child(ResFirebaseReference.getAbsolutePath(RefFireBaseBook.data_report_user)).child(user_id).
	...
	public String getReferenceName() {
		// TODO Auto-generated method stub
		return ResFirebaseReference.getInputPathReference(RefFireBaseBook.input_report_user);
	}
