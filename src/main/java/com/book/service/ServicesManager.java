...
public class ServicesManager {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		try {
			...
			avatar_default = prop.getProperty("avatar_default");
		...
		try {
			...
			DatabaseReference firebaseServiceManagerStatus = database.getReference("service_manager").child("status");

			firebaseServiceManagerStatus.addValueEventListener(new ValueEventListener() {
